...
class ChestPainForm(FormAction):
    """
    Form used to ask necessary questions to categorize patient with
    chest pain.

    Required slots are: infarction, pain_scale, pain_persistance, diabetes
    ...
    def name(self):
        ...
        return "chestpain_form"

    @staticmethod
    def required_slots(tracker: Tracker) -> List[Text]:
        """A list of required slots that the form has to fill"""
        return ["infarction", "pain_scale", "pain_persistance", "diabetes"]
